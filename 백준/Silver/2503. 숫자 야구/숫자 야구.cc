...
int main()
{
    ...
    while (T--)
    {
        ...
        {
            if (candidate[i])
                candidate[i] = check(guess, i, strike, ball);  
        }
    }
